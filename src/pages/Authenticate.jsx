...
const Authenticate = () => {
  ...
  const [email, setEmail] = useState("");
    ...
    const Step = activeTab === "phone" && currentStep === 1 ? StepPhone : activeTab === "email" && currentStep === 1 ? StepEmail : steps[currentStep];
  ...
  return (
    <div className="flex items-center justify-center mt-24">
      ...
      <Tabs
        ...
        className="w-2/5"
      >
        {currentStep === 1 && <TabsList className="bg-transparent flex items-end justify-end space-x-2">
          <TabsTrigger
            value="phone"
