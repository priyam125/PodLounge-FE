    ...
    <div className={`${containerStyles}`}>
      <div className="flex items-center justify-between my-5">
        <div className="flex items-center gap-5">
          <span className="text-lg font-bold after:content-[''] after:block after:w-[60%] after:h-[4px] after:bg-[#0077ff] after:bottom-4">All Voice Rooms</span>
          <div className="bg-[#262626] flex items-center px-2.5 min-w-[300px] rounded-[20px]">
            <SearchIcon />
            <input type="text" className="bg-transparent border-none outline-none p-2.5 text-white w-full" />
          </div>
        </div>
        <div className="right">
          <button className="flex items-center gap-2 bg-[#20bd5f] py-2.5 px-5 border-none outline-none rounded-[20px] text-white font-bold hover:bg-[#0f6632] transition-all ease-in-out duration-300">
            <RoomIcon />
